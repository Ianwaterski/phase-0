...
// The hardest part was trying to get the children added to the terah object.  When I started I was not using bracket notation for a new object for each child, but once I did it that way it was easy to assign them all.

// How difficult was it to add and delete properties outside of the object itself?
//  It was definitely an exercise trying to figure out what was going on but once I got a hold of it the first time it really fell into place.

// What did you learn about manipulating objects in this challenge?
//  I definitely got a better understanding of how adding objects is supposed to work.  Also to not only use the error messages in node but to take it to another interpreter and use console.log to see what the object's I was creating look like.  It was much easier to work with when I had a visual of what was happening.
